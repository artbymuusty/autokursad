...
async def _run(config: dict, mission_id: str) -> None:
    ...
    try:
        ...
        # PHASE 6.5: Gorev 3'un payload yolu artik payload/ paketinden gecer.
        # RealPayloadBackend MAVSDK Action nesnesini ENJEKTE alir, kendi
        # baglantisini kurmaz (Phase 4 karari); flight.drone MavsdkBackendBase
        # __init__'inde olusturuldugu icin burada hazirdir ve backend
        # construction'da hicbir I/O yapmaz.
        #
        # UYARI -- BILINEN BOSLUK (Phase 4 TODO(SAFETY), Phase 6.5'te gorunur
        # hale getirildi): FLEX-14..19 hala TBD (None) ve yakalamayi
        # dogrulayacak sensor yolu yok. Bu yuzden gercek donanimda
        # catch_box_down() ilk adimda PayloadCalibrationError yukseltir.
        # Bu bir cokme DEGIL: Gorev3PickupPhase._run_payload_pickup bunu
        # yakalayip temiz bir faz basarisizligina cevirir.
        payload_manager = PayloadManager(RealPayloadBackend(flight.drone.action))
