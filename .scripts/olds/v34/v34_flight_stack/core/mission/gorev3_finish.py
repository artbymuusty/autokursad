...
class Gorev3FinishPhase:
    ...
    async def run(self) -> None:
        ...
        for alt in GOREV3_DROP_CLIMB_STEPS_M:
            ...
            # BUG FIX (2026-08-21): ayni mutlak-NED hatasi (bkz.
            # gorev3_pickup.py) -- (0,0) EV demek, "yukselmek" degil.
            _fn, _fe, _ = await self.flight.get_position_ned()
            await self.flight.goto_position_ned_and_hold(_fn, _fe, -alt, yaw, 2.0)
