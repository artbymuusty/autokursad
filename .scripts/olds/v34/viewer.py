...
def main():
    ...
    cv2.namedWindow("KURSAD40 V34 - Ground Station Camera", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("KURSAD40 V34 - Ground Station Camera", 640, 480)
    ...
    try:
        while True:
            ...
            if frame is not None:
                ...
                cv2.imshow("KURSAD40 V34 - Ground Station Camera", frame)
            else:
                ...
                cv2.imshow("KURSAD40 V34 - Ground Station Camera", img)
